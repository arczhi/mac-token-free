...
BASE_PATH="${OMLX_BASE_PATH:-$HOME/.omlx-qwen36-35b-a3b-oq2-fp8kv-64k}"
...
MODEL_ALIAS="${OMLX_MODEL_ALIAS:-qwen36-35b-a3b-oq2-fp8kv-64k}"
OMLX_CLI="${OMLX_CLI:-}"

CACHE_DIR="${OMLX_CACHE_DIR:-$HOME/.omlx-cache/${MODEL_ALIAS}}"
SSD_CACHE_SIZE="${OMLX_SSD_CACHE_SIZE:-50GB}"
...
MAX_CONTEXT_WINDOW="${OMLX_MAX_CONTEXT_WINDOW:-65536}"
...
TURBOQUANT_KV_BITS="${OMLX_TURBOQUANT_KV_BITS:-8}"
...
echo "Starting oMLX Qwen3.6 35B A3B oQ2 VLM fp8-KV 64K server"
...
echo "  options:  thinking=false, VLM engine=on, MTP=on, DFlash2=off, SpecPrefill=off"
